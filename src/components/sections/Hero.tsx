  ...
  return (
    ...
    >
      ...
      <div className='flex flex-grow flex-col items-center justify-center md:justify-start'>
        <h1 className='relative mb-8 mt-4 flex flex-col items-center font-[family-name:--font-oswald] leading-none tracking-tighter md:mt-8 lg:mb-20 lg:mt-10 2xl:mb-12'>
